...
const AddSetPrize: React.FC<AddPrizeProps> = ({ statusEdit = false }) => {
    ...
    const handlePOSTSubmit = async () => {
        ...
        try {
            const { img, img2, img3 } = form.watch();
            const image_url_1 = await convertBase64(img);
    ...
    return (
        <Box component='section'>
            <TitleCard title='Add Set Prize' subtitle='Addtional description if required' isSearchExist={false} />
