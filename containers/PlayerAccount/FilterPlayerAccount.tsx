...
interface FilterPlayerAccountProps {
    form: any;
    nameActive: string;
    open: boolean;
    setOpen: any;
...
const FilterPlayerAccount: React.FC<FilterPlayerAccountProps> = ({ form, nameActive, open, setOpen, onFilter, onReset }) => {
    const handleClose = () => {
        setOpen(false);
    };
...
export default FilterPlayerAccount;
