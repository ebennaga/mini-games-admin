...
const TabProvince: React.FC<TabProvinceProps> = ({ data, value, index, row, handleChange, remove, goToNextPage, goToPreviousPage }) => {
    return (
