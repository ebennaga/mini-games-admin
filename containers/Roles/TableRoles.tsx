...
const TableRoles: React.FC<TableRolesProps> = ({ form, name }) => {
            ...
            <Table aria-label='table roles'>
                <TableHead>
                    <TableRow sx={{ bgcolor: '#F0F0F0', borderTop: '1px solid rgba(0,0,0,0.2)' }}>
                        ...
                        <TableCell sx={{ fontWeight: 400, fontSize: '16px', borderRight: '1px solid rgba(0,0,0,0.2)', width: '28%' }}>
                            Role Code
                        </TableCell>
                        <TableCell sx={{ fontWeight: 400, fontSize: '16px', borderRight: '1px solid rgba(0,0,0,0.2)', width: '28%' }}>
                            Role Name
                        </TableCell>
                        <TableCell sx={{ fontWeight: 400, fontSize: '16px', borderRight: '1px solid rgba(0,0,0,0.2)', width: '19%' }}>
                            Description
                        </TableCell>
                        <TableCell
                            align='center'
                        ...
                        <TableCell
                            align='center'
                            sx={{ fontWeight: 400, fontSize: '16px', borderRight: '1px solid rgba(0,0,0,0.2)', width: '8%' }}
                        >
                            More
                        </TableCell>
                    </TableRow>
                        ...
                        return (
                            <TableRow key={item.id}>
                                ...
                                <TableCell
                                    ...
                                    sx={{ fontWeight: 400, fontSize: '16px', borderRight: '1px solid rgba(0,0,0,0.2)', width: '6%' }}
                                >
                                    {item.isActive ? <BadgeCard bgcolor='#A54CE5' text='Yes' /> : <BadgeCard bgcolor='#D32F2F' text='No' />}
                                </TableCell>
                                <TableCell
                                    align='center'
                                    sx={{ fontWeight: 400, fontSize: '16px', borderRight: '1px solid rgba(0,0,0,0.2)', width: '6%' }}
